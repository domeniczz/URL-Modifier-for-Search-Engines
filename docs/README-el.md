...
Δεν μπορεί να υποστηρίξει την [Bing](https://www.bing.com), επειδή παρέχει μόνο ενδιάμεσους συνδέσμους.
...
Η 4get δεν θα αλλάξει τις εμφανιζόμενες διευθύνσεις URL αντίστοιχα όταν οι σύνδεσμοι αλλάζουν. Αυτό το πρόβλημα υπάρχει επειδή σκοπεύω να κάνω τον κώδικά μου όσο το δυνατόν πιο γενικευμένο, αλλά αυτές οι μηχανές αναζήτησης έχουν ασυνήθιστη δομή DOM για την εμφάνιση των διευθύνσεων URL, γεγονός που καθιστά κουραστικό την υποστήριξη αυτών των μηχανών λαμβάνοντας υπόψη τη σχετικά μικρή τους βάση χρηστών.
