...
Не вдасться змінити відображувані URL-адреси відповідно, коли посилання змінюються. Ця проблема існує, тому що я прагну зробити мій код якомога більш універсальним, але ці пошукові системи мають незвичайну структуру DOM для відображення URL-адрес, що робить підтримку цих систем втомливою, враховуючи їхню відносно малу користувацьку базу.
