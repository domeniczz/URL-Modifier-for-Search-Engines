...
Не удаётся поддержать [Bing](https://www.bing.com) и [Baidu](https://www.baidu.com), поскольку они предоставляют только промежуточные ссылки, которые не показывают целевой URL явно.
